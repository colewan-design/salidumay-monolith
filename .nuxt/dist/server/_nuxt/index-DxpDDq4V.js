import { ref, computed, watch, mergeProps, useSSRContext, resolveComponent, withCtx, createTextVNode, unref } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrRenderTeleport, ssrRenderAttr, ssrRenderComponent } from "vue/server-renderer";
import { useRouter } from "vue-router";
import "C:/salidumay-nuxt/node_modules/hookable/dist/index.mjs";
import { _ as _export_sfc } from "../server.mjs";
import { f as formatViews, g as getLibrary } from "./userdata-CDN2C6w4.js";
import { A as AppFooter } from "./AppFooter-DakCUiQ2.js";
import "./api-CaxJTo2b.js";
import "./tmdb-D41Aoa6c.js";
import "./tvSeries-7207TLND.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.loading && active.value && visible.value) {
        ...
        if (active.value.synopsis?.length > 160) {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (showTrailer.value && active.value?.trailerUrl) {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (authToast.value) {
          _push2(`<div class="auth-toast" data-v-f00a234b>Sign in to like anime</div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      _push(`<article class="${ssrRenderClass([__props.variant, "card"])}" data-v-f00a234b><div class="card-img-wrap" data-v-f00a234b><img${ssrRenderAttr("src", __props.anime.image)}${ssrRenderAttr("alt", __props.anime.title)} loading="lazy" data-v-f00a234b><div class="card-glitch-overlay" data-v-f00a234b></div>`);
      if (__props.anime.new) {
        _push(`<span class="img-badge badge-new" data-v-f00a234b>NEW</span>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.anime.status) {
        _push(`<span class="${ssrRenderClass([__props.anime.status === "Airing" ? "badge-airing" : "badge-done", "img-badge"])}" data-v-f00a234b>${ssrInterpolate(__props.anime.status === "Airing" ? "● AIRING" : "✓ DONE")}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="card-hover-info" data-v-f00a234b><button class="play-btn" aria-label="Watch" data-v-f00a234b><svg viewBox="0 0 24 24" fill="currentColor" data-v-f00a234b><path d="M8 5v14l11-7z" data-v-f00a234b></path></svg></button><button class="${ssrRenderClass(["add-btn", { saved: inLibrary.value }])}"${ssrRenderAttr("aria-label", inLibrary.value ? "Remove from library" : "Add to library")}${ssrRenderAttr("title", inLibrary.value ? "Remove from library" : "Add to library")} data-v-f00a234b><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="16" height="16" data-v-f00a234b>`);
      if (!inLibrary.value) {
        _push(`<path d="M12 5v14M5 12h14" stroke-linecap="round" data-v-f00a234b></path>`);
      } else {
        _push(`<path d="M5 13l4 4L19 7" stroke-linecap="round" stroke-linejoin="round" data-v-f00a234b></path>`);
      }
      _push(`</svg></button><button class="${ssrRenderClass(["add-btn", "heart-btn", { liked: liked.value }])}" title="Like" data-v-f00a234b><svg viewBox="0 0 24 24"${ssrRenderAttr("fill", liked.value ? "currentColor" : "none")} stroke="currentColor" stroke-width="2.2" width="15" height="15" data-v-f00a234b><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" stroke-linecap="round" stroke-linejoin="round" data-v-f00a234b></path></svg></button></div></div><div class="card-body" data-v-f00a234b><span class="card-genre" data-v-f00a234b>${ssrInterpolate(__props.anime.genre)}</span><h3 class="card-title" data-v-f00a234b>${ssrInterpolate(__props.anime.title)}</h3><div class="card-meta" data-v-f00a234b><span class="card-eps" data-v-f00a234b>${ssrInterpolate(__props.anime.episodes != null ? __props.anime.episodes + " ep" : __props.anime.status === "Airing" ? "Ongoing" : "? ep")}</span><span class="card-rating" data-v-f00a234b>★ ${ssrInterpolate(__props.anime.rating)}</span></div>`);
      if (views.value > 0) {
        _push(`<div class="card-views" data-v-f00a234b><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="11" height="11" data-v-f00a234b><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" data-v-f00a234b></path><circle cx="12" cy="12" r="3" data-v-f00a234b></circle></svg> ${ssrInterpolate(unref(formatViews)(views.value))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></article><!--]-->`);
...
const AnimeCard = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f00a234b"]]);
const _sfc_main$4 = {
  __name: "TrendingNow",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(genres, (g) => {
        _push(`<button class="genre-tile" style="${ssrRenderStyle({ background: g.gradient })}" data-v-9325420c><svg viewBox="0 0 24 24" class="genre-icon" data-v-9325420c>${g.svg ?? ""}</svg><span class="genre-name" data-v-9325420c>${ssrInterpolate(g.name)}</span><div class="genre-shine" data-v-9325420c></div></button>`);
      });
      _push(`<!--]--></div></section>`);
    };
  }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showAnime.value && becauseYouWatched.value.length) {
        _push(ssrRenderComponent(TrendingNow, {
          ...
          accent: lastWatched.value?.title ?? "",
          tag: "Recommended",
          tagColor: "cyan",
          link: "/trending"
        }, null, _parent));
...
//# sourceMappingURL=index-DxpDDq4V.js.map
