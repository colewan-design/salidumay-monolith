...
import { b as isInLibrary, i as incrementViewCount, r as recordHistory } from "./userdata-CDN2C6w4.js";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="bc-sep" data-v-ca6999f2>›</span><span class="bc-current" data-v-ca6999f2>${ssrInterpolate(anime.value?.title || "…")}</span>`);
      ...
      if (activeTab.value === "episodes") {
        ...
        if (seasons.value.length) {
          ...
          if (anime.value?.image) {
            ...
            _push(`<div class="season-card-img-ph" data-v-ca6999f2>${ssrInterpolate(anime.value?.title?.[0])}</div>`);
          }
          _push(`</div><div class="season-card-info" data-v-ca6999f2><span class="season-card-badge current" data-v-ca6999f2>Current</span><span class="season-card-title" data-v-ca6999f2>${ssrInterpolate(anime.value?.title)}</span></div></div><!--[-->`);
          ssrRenderList(seasons.value, (s) => {
            ...
            if (s.image) {
              ...
              _push(`<div class="season-card-img-ph" data-v-ca6999f2>${ssrInterpolate(s.title?.[0])}</div>`);
            }
      ...
      if (loading.value) {
        ...
        if (anime.value.studio) {
          _push(`<div class="s-stat" data-v-ca6999f2><span class="s-stat-icon" data-v-ca6999f2>🎬</span><div data-v-ca6999f2><span class="s-stat-val" data-v-ca6999f2>${ssrInterpolate(anime.value.studio)}</span><span class="s-stat-label" data-v-ca6999f2>Studio</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (allSources.value.length) {
          _push(`<div class="dt-row" data-v-ca6999f2><span class="dt-key" data-v-ca6999f2>Stream</span><span class="dt-val text-cyan" data-v-ca6999f2>${ssrInterpolate(allSources.value[0]?.group || "Available")} ✓</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><!--]-->`);
...
//# sourceMappingURL=_ep_-9mpM94ZU.js.map
