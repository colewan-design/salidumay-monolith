...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderClass } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="empty-state" data-v-96f9aa20><div class="empty-icon" data-v-96f9aa20>📚</div><p data-v-96f9aa20>Sign in to save anime to your library.</p><button class="cta-btn" data-v-96f9aa20>Sign In</button></div>`);
      } else if (!library2.value.length) {
        _push(`<div class="empty-state" data-v-96f9aa20><div class="empty-icon" data-v-96f9aa20>📭</div><p data-v-96f9aa20>Your library is empty. Start adding films and anime!</p><div style="${ssrRenderStyle({ "display": "flex", "gap": ".6rem", "justify-content": "center", "flex-wrap": "wrap" })}" data-v-96f9aa20><button class="cta-btn" data-v-96f9aa20>Browse Anime</button><button class="cta-btn" style="${ssrRenderStyle({ "background": "var(--cyan)", "color": "#060e14" })}" data-v-96f9aa20>Browse Films</button></div></div>`);
      } else {
...
//# sourceMappingURL=library-4GbBY2gO.js.map
