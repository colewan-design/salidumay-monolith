  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="empty" data-v-aec27de6><p class="empty-icon" data-v-aec27de6>🌸</p><p class="empty-title" data-v-aec27de6>No seasonal anime found</p><p class="empty-sub" data-v-aec27de6>Try running the scraper to populate data</p></div>`);
      }
      _push(`</main>`);
...
//# sourceMappingURL=seasonal-Dt1QSe3D.js.map
