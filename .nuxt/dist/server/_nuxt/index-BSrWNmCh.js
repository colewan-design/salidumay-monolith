  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="empty" data-v-569f0399><p class="empty-icon" data-v-569f0399>🎬</p><p class="empty-title" data-v-569f0399>No results</p><p class="empty-sub" data-v-569f0399>Try a different search or category</p></div>`);
      }
...
//# sourceMappingURL=index-BSrWNmCh.js.map
