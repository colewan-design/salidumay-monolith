...
import { c as getSeriesDetail } from "./tvSeries-7207TLND.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="bc-sep" data-v-6952df97>›</span><span class="bc-current" data-v-6952df97>${ssrInterpolate(series.value?.title || "…")}</span></div>`);
      if (series.value?.backdrop) {
      ...
      if (loading.value) {
        ...
        _push(`<!--[-->`);
        if (series.value?.backdrop) {
          _push(`<img${ssrRenderAttr("src", series.value.backdrop)} class="hero-backdrop"${ssrRenderAttr("alt", series.value?.title)} data-v-6952df97>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (series.value) {
        ...
        if (series.value.similar?.length) {
        ...
        if (activeTab.value === "episodes") {
          ...
          if (visibleSeasons.value.length > 1) {
            ...
            ssrRenderList(visibleSeasons.value, (s) => {
              _push(`<button class="${ssrRenderClass(["season-btn", { active: activeSeason.value?.season_number === s.season_number }])}" data-v-6952df97>Season ${ssrInterpolate(s.season_number)}</button>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          ...
          if (!currentEpisodes.value.length) {
            ...
            ssrRenderList(currentEpisodes.value, (ep) => {
              _push(`<div class="${ssrRenderClass(["ep-card", { active: activeEp.value?.episode_number === ep.episode_number && isPlaying.value }])}" data-v-6952df97><div class="ep-still" data-v-6952df97>`);
              if (ep.still_url) {
        ...
        if (activeTab.value === "similar") {
          ...
          ssrRenderList(series.value.similar, (s) => {
            ...
            if (s.image) {
              ...
              _push(`<div class="rel-placeholder" data-v-6952df97>📺</div>`);
            }
      ...
      if (loading.value) {
        ...
        if (series.value.year) {
          _push(`<div class="stat" data-v-6952df97><span class="stat-icon" data-v-6952df97>📅</span><div data-v-6952df97><span class="stat-val" data-v-6952df97>${ssrInterpolate(series.value.year)}</span><span class="stat-lbl" data-v-6952df97>Year</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (series.value.number_of_seasons) {
          _push(`<div class="stat" data-v-6952df97><span class="stat-icon" data-v-6952df97>📺</span><div data-v-6952df97><span class="stat-val" data-v-6952df97>${ssrInterpolate(series.value.number_of_seasons)}</span><span class="stat-lbl" data-v-6952df97>Seasons</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (series.value.voteCount) {
          _push(`<div class="dt-row" data-v-6952df97><span class="dt-key" data-v-6952df97>Votes</span><span class="dt-val" data-v-6952df97>${ssrInterpolate(series.value.voteCount?.toLocaleString())}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        if (series.value.created_by?.length) {
...
//# sourceMappingURL=index-gKPqBpRL.js.map
