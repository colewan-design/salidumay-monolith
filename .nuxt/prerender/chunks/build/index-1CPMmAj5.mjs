...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent } from 'file://C:/salidumay-nuxt/node_modules/vue/server-renderer/index.mjs';
import { A as AppFooter } from './AppFooter-DakCUiQ2.mjs';
import { s as searchSeries, b as getSeriesByGenre, g as getAiringTodaySeries, d as getTopRatedSeries, e as getTrendingSeries, a as getPopularSeries } from './tvSeries-7207TLND.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-06debb10><section class="banner" data-v-06debb10><div class="banner-bg" data-v-06debb10></div><div class="banner-content" data-v-06debb10><span class="tag" data-v-06debb10>Television</span><h1 class="title" data-v-06debb10>TV <span class="accent" data-v-06debb10>Series</span></h1><p class="sub" data-v-06debb10>Drama \xB7 Thriller \xB7 Sci-Fi \xB7 Fantasy \xB7 Comedy</p><div class="search-bar" data-v-06debb10><svg class="search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" data-v-06debb10><circle cx="11" cy="11" r="7" data-v-06debb10></circle><path d="m21 21-4.35-4.35" data-v-06debb10></path></svg><input${ssrRenderAttr("value", searchQuery.value)} class="search-input" placeholder="Search series\u2026" autocomplete="off" data-v-06debb10>`);
      if (searching.value) {
      ...
      if (loading.value) {
        ...
        _push(`<div class="empty" data-v-06debb10><p class="empty-icon" data-v-06debb10>\u{1F4FA}</p><p class="empty-title" data-v-06debb10>No results</p><p class="empty-sub" data-v-06debb10>Try a different search or category</p></div>`);
      }
...
//# sourceMappingURL=index-1CPMmAj5.mjs.map
