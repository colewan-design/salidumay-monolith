...
import { ref, watch, mergeProps, withCtx, createTextVNode, unref, useSSRContext } from 'file://C:/salidumay-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderTeleport } from 'file://C:/salidumay-nuxt/node_modules/vue/server-renderer/index.mjs';
import { g as getFilmDetail, F as FILM_EMBED_SOURCES } from './tmdb-D41Aoa6c.mjs';
import { f as formatViews, b as isInLibrary, c as isLiked, a as getViewCount, i as incrementViewCount } from './userdata-CDN2C6w4.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useSeoMeta({
      ...
      description: () => {
        var _a;
        return ((_a = film.value) == null ? void 0 : _a.overview) || "Watch this film on Salidumay.";
      }
    });
    async function fetchFilm(id) {
      ...
      if (data) {
        ...
        liked.value = (_a = data.user_liked) != null ? _a : isLiked();
        likesCount.value = (_b = data.likes) != null ? _b : 0;
        views.value = (_c = data.views) != null ? _c : getViewCount();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="bc-sep" data-v-9411c89f>\u203A</span><span class="bc-current" data-v-9411c89f>${ssrInterpolate(((_a = film.value) == null ? void 0 : _a.title) || "\u2026")}</span></div>`);
      if ((_b = film.value) == null ? void 0 : _b.backdrop) {
      ...
      _push(`</div>`);
      if ((_c = film.value) == null ? void 0 : _c.tagline) {
        _push(`<p class="tagline" data-v-9411c89f>&quot;${ssrInterpolate(film.value.tagline)}&quot;</p>`);
      } else {
        _push(`<!---->`);
      }
      if ((_d = film.value) == null ? void 0 : _d.overview) {
        ...
        if (activeTab.value === "related") {
          ...
          ssrRenderList(film.value.similar, (m) => {
            ...
            if (m.image) {
              ...
              _push(`<div class="rel-placeholder" data-v-9411c89f>\u{1F3AC}</div>`);
            }
      ...
      if (loading.value) {
        ...
        if (film.value.year) {
          _push(`<div class="stat" data-v-9411c89f><span class="stat-icon" data-v-9411c89f>\u{1F4C5}</span><div data-v-9411c89f><span class="stat-val" data-v-9411c89f>${ssrInterpolate(film.value.year)}</span><span class="stat-lbl" data-v-9411c89f>Year</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (film.value.runtime) {
        ...
        if (views.value > 0) {
          _push(`<div class="stat" data-v-9411c89f><span class="stat-icon" data-v-9411c89f>\u{1F441}</span><div data-v-9411c89f><span class="stat-val" data-v-9411c89f>${ssrInterpolate(unref(formatViews)(views.value))}</span><span class="stat-lbl" data-v-9411c89f>Views</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=index-WQ29iYkL.mjs.map
