...
import { ref, mergeProps, unref, withCtx, createTextVNode, useSSRContext } from 'file://C:/salidumay-nuxt/node_modules/vue/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const tiers = [
      ...
      { label: "Meal", amount: "\u20B1200", usd: "$4", icon: "\u{1F35C}", desc: "Fuel for the next feature" },
      { label: "Supporter", amount: "\u20B1500", usd: "$9", icon: "\u2B50", desc: "You're a true fan" },
      { label: "Patron", amount: "\u20B11000", usd: "$18", icon: "\u{1F451}", desc: "Legendary support" }
    ];
    const copied = ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-77b32f9c><div class="hero" data-v-77b32f9c><div class="hero-bg" data-v-77b32f9c></div><div class="hero-content" data-v-77b32f9c><div class="heart-icon" data-v-77b32f9c>\u{1F496}</div><h1 class="hero-title" data-v-77b32f9c>Support <span class="accent" data-v-77b32f9c>Salidumay</span></h1><p class="hero-sub" data-v-77b32f9c> Salidumay is a passion project built and maintained by one developer.<br data-v-77b32f9c> Your support helps keep the servers running and new features coming \u2014 with no ads. </p></div></div><main class="wrap" data-v-77b32f9c><section class="why-section" data-v-77b32f9c><div class="why-grid" data-v-77b32f9c><div class="why-card" data-v-77b32f9c><span class="why-icon" data-v-77b32f9c>\u{1F6AB}</span><h3 data-v-77b32f9c>No Ads</h3><p data-v-77b32f9c>Your support keeps the experience clean and distraction-free.</p></div><div class="why-card" data-v-77b32f9c><span class="why-icon" data-v-77b32f9c>\u26A1</span><h3 data-v-77b32f9c>Faster Updates</h3><p data-v-77b32f9c>Better funding means more time to build features you love.</p></div><div class="why-card" data-v-77b32f9c><span class="why-icon" data-v-77b32f9c>\u{1F310}</span><h3 data-v-77b32f9c>Keep It Online</h3><p data-v-77b32f9c>Server costs are real. Your contribution keeps the lights on.</p></div><div class="why-card" data-v-77b32f9c><span class="why-icon" data-v-77b32f9c>\u{1F38C}</span><h3 data-v-77b32f9c>For Anime Fans</h3><p data-v-77b32f9c>Built by a fan, for fans. Every peso goes back into the project.</p></div></div></section><section class="tiers-section" data-v-77b32f9c><h2 class="section-title" data-v-77b32f9c>Choose Your Support</h2><div class="tiers-grid" data-v-77b32f9c><!--[-->`);
...
//# sourceMappingURL=support-DehDhYeD.mjs.map
