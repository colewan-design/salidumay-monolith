    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoggedIn)) {
        ...
        if ((_a = unref(user)) == null ? void 0 : _a.avatar) {
          ...
          _push(`<span data-v-6840ae47>${ssrInterpolate(((_d = (_c = (_b = unref(user)) == null ? void 0 : _b.name) == null ? void 0 : _c[0]) == null ? void 0 : _d.toUpperCase()) || "U")}</span>`);
        }
        _push(`</div><div class="user-info" data-v-6840ae47><span class="user-name" data-v-6840ae47>${ssrInterpolate((_e = unref(user)) == null ? void 0 : _e.name)}</span><span class="user-email" data-v-6840ae47>${ssrInterpolate((_f = unref(user)) == null ? void 0 : _f.email)}</span></div></div><button class="signout-btn" data-v-6840ae47>Sign Out</button><!--]-->`);
      } else {
        _push(`<!--[-->`);
        _push(ssrRenderComponent(unref(RouterLink), {
          to: "/login",
...
//# sourceMappingURL=default-BKqvg4Zk.mjs.map
