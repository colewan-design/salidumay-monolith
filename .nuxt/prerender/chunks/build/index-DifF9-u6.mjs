...
import { ref, watch, mergeProps, withCtx, createTextVNode, useSSRContext } from 'file://C:/salidumay-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass } from 'file://C:/salidumay-nuxt/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="bc-sep" data-v-ae37e569>\u203A</span><span class="bc-current" data-v-ae37e569>${ssrInterpolate(((_a = film.value) == null ? void 0 : _a.title) || "\u2026")}</span></div>`);
        ...
        if (activeTab.value === "related") {
          ...
          ssrRenderList(film.value.similar, (m) => {
            ...
            if (m.image) {
              ...
              _push(`<div class="rel-placeholder" data-v-ae37e569>\u{1F3AC}</div>`);
            }
      ...
      if (loading.value) {
        ...
        if (film.value.year) {
          _push(`<div class="stat" data-v-ae37e569><span class="stat-icon" data-v-ae37e569>\u{1F4C5}</span><div data-v-ae37e569><span class="stat-val" data-v-ae37e569>${ssrInterpolate(film.value.year)}</span><span class="stat-lbl" data-v-ae37e569>Year</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (film.value.runtime) {
...
//# sourceMappingURL=index-DifF9-u6.mjs.map
