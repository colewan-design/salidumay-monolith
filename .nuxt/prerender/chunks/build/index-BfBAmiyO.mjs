  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="empty" data-v-b50a006a><p class="empty-icon" data-v-b50a006a>\u{1F3AC}</p><p class="empty-title" data-v-b50a006a>No results</p><p class="empty-sub" data-v-b50a006a>Try a different search or category</p></div>`);
      }
...
//# sourceMappingURL=index-BfBAmiyO.mjs.map
