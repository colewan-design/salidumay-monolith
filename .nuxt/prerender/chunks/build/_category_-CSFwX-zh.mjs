...
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrIncludeBooleanAttr } from 'file://C:/salidumay-nuxt/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="empty" data-v-1bd3b732><p class="empty-icon" data-v-1bd3b732>\u{1F3AC}</p><p class="empty-title" data-v-1bd3b732>No films found</p><p class="empty-sub" data-v-1bd3b732>Try a different category</p></div>`);
      }
...
//# sourceMappingURL=_category_-CSFwX-zh.mjs.map
