...
import { i as isInLibrary, r as recordHistory } from './userdata-CGpZM_-a.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="bc-sep" data-v-54407896>\u203A</span><span class="bc-current" data-v-54407896>${ssrInterpolate(((_a = anime.value) == null ? void 0 : _a.title) || "\u2026")}</span>`);
      ...
      if (activeTab.value === "episodes") {
        ...
        if (seasons.value.length) {
          ...
          if ((_d = anime.value) == null ? void 0 : _d.image) {
            ...
            _push(`<div class="season-card-img-ph" data-v-54407896>${ssrInterpolate((_f = (_e = anime.value) == null ? void 0 : _e.title) == null ? void 0 : _f[0])}</div>`);
          }
          _push(`</div><div class="season-card-info" data-v-54407896><span class="season-card-badge current" data-v-54407896>Current</span><span class="season-card-title" data-v-54407896>${ssrInterpolate((_g = anime.value) == null ? void 0 : _g.title)}</span></div></div><!--[-->`);
          ssrRenderList(seasons.value, (s) => {
            ...
            if (s.image) {
              ...
              _push(`<div class="season-card-img-ph" data-v-54407896>${ssrInterpolate((_a2 = s.title) == null ? void 0 : _a2[0])}</div>`);
            }
      ...
      if (loading.value) {
        ...
        if (anime.value.studio) {
          _push(`<div class="s-stat" data-v-54407896><span class="s-stat-icon" data-v-54407896>\u{1F3AC}</span><div data-v-54407896><span class="s-stat-val" data-v-54407896>${ssrInterpolate(anime.value.studio)}</span><span class="s-stat-label" data-v-54407896>Studio</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (allSources.value.length) {
          _push(`<div class="dt-row" data-v-54407896><span class="dt-key" data-v-54407896>Stream</span><span class="dt-val text-cyan" data-v-54407896>${ssrInterpolate(((_i = allSources.value[0]) == null ? void 0 : _i.group) || "Available")} \u2713</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><!--]-->`);
...
//# sourceMappingURL=_ep_-CVgAXT3d.mjs.map
